# Architecture Decision Records (ADRs) for TimeTracker_2

## Frontend

| ADR | Title | Status |
|-----|-------|--------|
| [ADR-10001](./1-frontend/ADR-10001-angular-v21-as-frontend-framework.md) | Angular v21+ as Frontend Framework | proposed |
| [ADR-10002](./1-frontend/ADR-10002-signal-based-state-management.md) | Signal-based State Management without External Libraries | proposed |
| [ADR-10003](./1-frontend/ADR-10003-angular-material-as-component-library.md) | Angular Material as UI Component Library | proposed |
| [ADR-10004](./1-frontend/ADR-10004-scss-with-stylelint.md) | SCSS with Stylelint as Styling Approach | proposed |
| [ADR-10005](./1-frontend/ADR-10005-module-based-architecture.md) | Module-based Architecture with Lazy Loading | proposed |
| [ADR-10006](./1-frontend/ADR-10006-strict-typescript-configuration.md) | Strict TypeScript Configuration | proposed |
| [ADR-10007](./1-frontend/ADR-10007-path-aliases.md) | TypeScript Path Aliases for Clean Imports | proposed |
| [ADR-10008](./1-frontend/ADR-10008-code-quality-tooling.md) | Code Quality Tooling | proposed |
| [ADR-10009](./1-frontend/ADR-10009-date-fns-as-date-utility.md) | date-fns as Date Utility Library | proposed |
| [ADR-10010](./1-frontend/ADR-10010-transloco-as-i18n-library.md) | Transloco as i18n Library | proposed |
...
| [ADR-10016](./1-frontend/ADR-10016-vitest-as-unit-testing-framework.md) | Vitest as Unit Testing Framework | accepted |
| [ADR-10017](./1-frontend/ADR-10017-provider-and-service-error-handling.md) | Provider and Service Error Handling via Toast | accepted |

## Backend Integration

| ADR | Title | Status |
|-----|-------|--------|
| [ADR-20001](./2-backend-integration/ADR-20001-backend-abstraction-layer.md) | Backend Abstraction Layer | proposed |
| [ADR-20002](./2-backend-integration/ADR-20002-supabase-as-primary-backend.md) | Supabase as Primary Backend Implementation | proposed |
...
| ADR | Title | Status |
|-----|-------|--------|
| [ADR-40001](./4-database/ADR-40001-data-model-design.md) | Data Model Design | proposed |
